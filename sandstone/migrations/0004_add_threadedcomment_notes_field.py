...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThreadedComment.comment_notes'
        db.add_column(u'generic_threadedcomment', u'comment_notes',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThreadedComment.comment_notes'
        db.delete_column(u'generic_threadedcomment', u'comment_notes')
    ...
    models = {
        ...
        u'generic.threadedcomment': {
            ...
            u'comment_notes': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
