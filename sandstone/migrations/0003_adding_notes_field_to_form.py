...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.form_notes'
        db.add_column(u'forms_form', u'form_notes',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.form_notes'
        db.delete_column(u'forms_form', u'form_notes')
    ...
    models = {
        ...
        u'forms.form': {
            ...
            u'form_notes': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
