...
project = u'mobilepartners.mozilla.org'
...
latex_documents = [
  ('index', 'mobilepartners.tex', u'Mobilepartners Documentation',
   u'Mozilla', 'manual'),
]
...
man_pages = [
    ('index', 'mobilepartners.mozilla.org', u'Mobilepartners Documentation',
     [u'Mozilla'], 1)
]
