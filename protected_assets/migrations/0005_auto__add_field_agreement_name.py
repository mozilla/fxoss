...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agreement.name'
        db.add_column(u'protected_assets_agreement', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Prototype Branding Agreement', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agreement.name'
        db.delete_column(u'protected_assets_agreement', 'name')
