...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agreement.language'
        db.add_column(u'protected_assets_agreement', 'language',
                      self.gf('django.db.models.fields.CharField')(default=u'en', max_length=10),
                      keep_default=False)

        # Adding field 'Agreement.translated_from'
        db.add_column(u'protected_assets_agreement', 'translated_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='translations', null=True, to=orm['protected_assets.Agreement']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Agreement.language'
        db.delete_column(u'protected_assets_agreement', 'language')

        # Deleting field 'Agreement.translated_from'
        db.delete_column(u'protected_assets_agreement', 'translated_from_id')
    ...
    models = {
        ...
        u'protected_assets.agreement': {
            ...
            'translated_from': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'translations'", 'null': 'True', 'to': u"orm['protected_assets.Agreement']"}),
