...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SignedAgreement', fields ['user', 'agreement']
        db.create_unique(u'protected_assets_signedagreement', ['user_id', 'agreement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SignedAgreement', fields ['user', 'agreement']
        db.delete_unique(u'protected_assets_signedagreement', ['user_id', 'agreement_id'])
