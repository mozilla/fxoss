...
class Migration(SchemaMigration):
    """Initial internalized migration for mezzanine forms models as of 3.0.6"""
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forms_field', (
            ...
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fields', to=orm['forms.Form'])),
        ...
        db.create_table(u'forms_formentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'entries', to=orm['forms.Form'])),
        ...
        db.create_table(u'forms_fieldentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fields', to=orm['forms.FormEntry'])),
