...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserNotes'
        db.create_table(u'registration_salesforce_usernotes', (
    ...
    models = {
        ...
        u'registration_salesforce.profile': {
            ...
            'company': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
        ...
        u'registration_salesforce.usernotes': {
